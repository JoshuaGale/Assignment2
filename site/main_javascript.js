...
function familyMembership(family) {
	var i;
	if (family == 1) {
		for (i = 1; i < 7; i++) {
			document.getElementById("childForm" + i.toString()).readOnly = false; 
		}
	} else {
		for (i = 1; i < 7; i++) {
			document.getElementById("childForm" + i.toString()).readOnly = true; 
			document.getElementById("childForm" + i.toString()).value = "";
		}
	}
}
...
function studentNumber(student) {
	if (student == 1) {
		document.getElementById("consessionNumber").readOnly = false; 
	} else {
		document.getElementById("consessionNumber").readOnly = true;
		document.getElementById("consessionNumber").value = "";
	}
}
